<div>
  {{-- componente editar periodo de preordenes --}}
  <article class="m-2 border rounded-sm border-neutral-200">

    {{-- barra de titulo --}}
    <x-title-section title="crear periodo de preordenes de compra">
      @if ($has_previous_quotation_period)
        <x-a-button
          wire:navigate
          href="{{ route('suppliers-budgets-ranking', $previous_quotation_period->id) }}"
      ...
      <x-slot:footer class="mt-2">
        ...
        <div class="flex justify-end gap-2 my-2">
          ...
          <x-btn-button
            type="button"
            wire:click="save()"
            wire:confirm="¿editar periodo de pre orden?. Si la fecha de inicio es el dia de hoy, el periodo abrira inmediatamente y se contactará a los proveedores activos."
            >editar
          </x-btn-button>
