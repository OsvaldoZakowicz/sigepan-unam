<div>
  ...
  <article class="m-2 border rounded-sm border-neutral-200">
    ...
    {{-- barra de titulo --}}
    <x-title-section title="editar el periodo de petición de presupuestos"></x-title-section>
      ...
      <x-slot:content class="flex-col">
        ...
        <form class="flex flex-col w-full gap-1">
          ...
          <x-div-toggle x-data="{open: true}" title="datos del período" class="p-2">
            ...
            <div class="flex gap-1 min-h-fit">
              ...
              <div class="flex flex-col w-full gap-1 min-h-fit md:w-1/2 lg:grow">
                ...
                @error('period_short_description')
                  <span class="text-xs text-red-400">{{ $message }}</span>
                @enderror
                <input
                  type="text"
          ...
          <x-div-toggle x-data="{open: true}" title="suministros y packs a presupuestar" class="p-2">
            ...
            {{-- leyenda --}}
            <x-slot:subtitle>
              <span class="text-sm text-neutral-600">se presupuestarán suministros y packs de proveedores <x-text-tag color="emerald">activos</x-text-tag> </span>
            </x-slot:subtitle>

            {{-- cuadro de busqueda --}}
            @livewire('suppliers.search-provision-period', ['is_editing' => true])
