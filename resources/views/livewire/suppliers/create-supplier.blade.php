<div>
  ...
  <x-content-section>
    ...
    <x-slot:content class="flex-col">
      ...
      <form wire:submit="save" wire:confirm="¿crear proveedor?" class="flex flex-col w-full gap-2">
        ...
        <x-div-toggle
          ...
          <x-fieldset-base tema="credenciales de acceso del proveedor" class="w-full">
            ...
            {{-- contrasenia --}}
            <div class="flex flex-col justify-end w-full gap-1 p-2 md:w-1/2 lg:w-1/4">
