  ...
  <article class="m-2 border rounded-sm border-neutral-200">
    ...
    <x-content-section>
      ...
      <x-slot:content class="flex-col">
        ...
        <form wire:submit="update" wire:confirm="¿editar proveedor?" class="flex flex-col w-full gap-2">
          ...
          <x-div-toggle x-data="{ open: false }" title="proveedor" subtitle="Editar los siguientes datos del proveedor y su direccion." class="p-2">
            ...
            <x-fieldset-base tema="comercio o empresa" class="w-full">
              ...
              <div class="flex flex-col w-full gap-1 p-2 md:w-1/2 lg:w-1/4">
                ...
                <input wire:model="company_cuit" type="text" name="company_cuit" class="w-full p-1 text-sm border border-neutral-200 focus:outline-none focus:ring focus:ring-neutral-300"></input>
              </div>
              {{-- condicion iva --}}
              <div class="flex flex-col w-full gap-1 p-2 md:w-1/2 lg:w-1/4">
                <span>
                ...
                <select wire:model="company_iva" name="company_iva" id="company_iva" class="w-full p-1 text-sm border border-neutral-200 focus:outline-none focus:ring focus:ring-neutral-300">
              ...
              <div class="flex flex-col w-full gap-1 p-2 md:w-1/2 lg:w-1/4">
                ...
                <input wire:model="company_phone" type="tel" name="company_phone" class="w-full p-1 text-sm border border-neutral-200 focus:outline-none focus:ring focus:ring-neutral-300"></input>
              </div>
              {{-- descripcion opcional --}}
              <div class="flex flex-col w-full gap-1 p-2 md:w-1/2 lg:w-full">
                <span>
                ...
                <textarea wire:model="company_short_desc" name="company_short_desc" rows="2" cols="10" class="w-full p-1 text-sm border border-neutral-200 focus:outline-none focus:ring focus:ring-neutral-300"></textarea>
              </div>
            </x-fieldset-base>
            ...
            <x-fieldset-base tema="direccion">
              ...
              <div class="flex flex-col w-full gap-1 p-2 md:w-1/2 lg:w-1/4">
                ...
                <x-text-input wire:model="company_street" id="company_street" name="company_street" type="text" class="block w-full mt-1" />
              </div>
              {{-- numero de calle --}}
              <div class="flex flex-col w-full gap-1 p-2 md:w-1/2 lg:w-1/4">
                <span>
                ...
                <x-text-input wire:model="company_number" id="company_number" name="company_number" type="text" class="block w-full mt-1" />
              </div>
              {{-- ciudad --}}
              <div class="flex flex-col w-full gap-1 p-2 md:w-1/2 lg:w-1/4">
                <span>
                ...
                <x-text-input wire:model="company_city" id="company_city" name="company_city" type="text" class="block w-full mt-1" />
              </div>
              {{-- codigo postal --}}
              <div class="flex flex-col w-full gap-1 p-2 md:w-1/2 lg:w-1/4">
                <span>
                ...
                <x-text-input wire:model="company_postal_code" id="company_postal_code" name="company_postal_code" type="text" class="block w-full mt-1" />
              </div>
            </x-fieldset-base>
            ...
            <x-fieldset-base tema="estado" class="w-full">
              ...
              <div class="flex flex-col gap-2 p-2 w-fit-content">
                ...
                <div class="flex gap-2">
                  <div class="p-1 border rounded-sm border-neutral-200 h-min">
              ...
              @if ($status_changed)
                <div class="flex flex-col w-full gap-1 p-2 md:w-1/2 lg:grow">
                  ...
                  <x-text-input wire:model="status_new_description" id="status_new_description" name="status_new_description" type="text" class="block w-full mt-1" />
                </div>
              @else
                {{-- solo visualizar descripcion --}}
                <div class="flex flex-col w-full gap-1 p-2 md:w-1/2 lg:grow">
                  <label for="status_description" class="capitalize max-w-fit">Estado actual del proveedor</label>
                  <x-text-input disabled wire:model="status_description" type="text" class="block w-full mt-1 bg-neutral-200" />
                </div>
              @endif
