<div>
  {{-- componente editar categoria de suministros--}}
  <article class="m-2 border rounded-sm border-neutral-200">

    {{-- barra de titulo --}}
    <x-title-section title="editar categoria de suministros"></x-title-section>
    ...
    <x-content-section>
      ...
      <x-slot:content class="flex-col">
        ...
        <form  wire:submit="save" wire:confirm="¿editar categoría?" class="flex flex-col w-full gap-2">
