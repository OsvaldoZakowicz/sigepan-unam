...
new #[Layout('layouts.guest')] class extends Component {
    ...
    public function logout(Logout $logout): void
    {
        ...
        $this->redirect('store-store-index', navigate: true);
    }
}; ?>
...
<div>
    ...
    <div class="mt-4 flex items-center justify-between">
        <button wire:click="sendVerification" type="submit"
            class="flex justify-center items-center box-border w-fit h-6 m-1 p-1 border-solid border rounded border-blue-600 bg-blue-600 text-center text-neutral-100 uppercase text-xs">
