            ...
            <div class="flex flex-col gap-2">
                ...
                <div class="flex flex-col gap-1 min-h-fit w-full">
                  ...
                  <div class="flex justify-start items-center gap-1">
                    ...
                    <select
                      ...
                      class="w-1/4 p-1 text-sm border border-neutral-200 focus:outline-none focus:ring focus:ring-neutral-300">
                    ...
                    <div class="flex justify-start items-center gap-1 ml-2 p-1 min-h-8 border border-dashed border-neutral-200 leading-none overflow-y-auto overflow-x-auto">
              ...
              <div class="flex min-h-fit">
                ...
                <div class="flex flex-col gap-1 min-h-fit w-full">
                  ...
                  <textarea wire:model="product_short_description" name="product_short_description" rows="2" cols="10" class="p-1 text-sm w-full border border-neutral-200 focus:outline-none focus:ring focus:ring-neutral-300"></textarea>
                </div>
              </div>
            </div>
