      ...
      <div class="flex grow justify-center md:justify-start">
        <div class="flex flex-col gap-4">
          @if (!$user->profile)
            ...
            {{-- ruta a completar perfil de cliente --}}
            <a
              href="{{route('profile-client-complete')}}"
              class="flex justify-center items-center box-border w-fit h-6 p-1 border-solid border rounded border-blue-600 bg-blue-600 text-center text-neutral-100 uppercase text-xs">completar perfil</a>
          @else
            {{-- ruta a completar perfil de cliente, en edicion --}}
            <a
              href="{{route('profile-client-complete')}}"
              class="flex justify-center items-center box-border w-fit h-6 p-1 border-solid border rounded border-neutral-200 bg-neutral-100 text-center text-neutral-600 uppercase text-xs">editar perfil</a>
          @endif
        </div>
      </div>
    </div>
