  ...
  */
  public function mount(int $id): void
  {
    ...
    if (RequestForQuotationPeriod::whereHas('status', function ($query) {
      ...
      session()->flash('operation-info', 'No puede editar precios mientras existan periodos de presupuestos programados o abiertos');
    ...
    if (PreOrderPeriod::whereHas('status', function ($query) {
      ...
      session()->flash('operation-info', 'No puede editar precios mientras existan periodos de preordenes programados o abiertos');
      $this->redirectRoute('suppliers-suppliers-price-index', $this->supplier->id);
    }
